...
public final class GroupInfo extends
            ...
            while (!done) {
                ...
                switch (tag) {
                    ...
                    case 18: {
                        ...
                        leader_ = input.readMessage(EmployeeInfo.parser(), extensionRegistry);
                        if (subBuilder != null) {
    ...
    public EmployeeInfo getLeader() {
        return leader_ == null ? EmployeeInfo.getDefaultInstance() : leader_;
    }
     ...
     */
    @Override
    public EmployeeInfoOrBuilder getLeaderOrBuilder() {
        return getLeader();
    }
    ...
    public static final class Builder extends
        ...
        public Builder mergeFrom(GroupInfo other) {
            if (other == GroupInfo.getDefaultInstance()) {
                return this;
            }
            if (other.getId() != 0L) {
                setId(other.getId());
        ...
        private EmployeeInfo leader_ = null;
        private com.google.protobuf.SingleFieldBuilderV3<
                EmployeeInfo, EmployeeInfo.Builder, EmployeeInfoOrBuilder> leaderBuilder_;
         ...
         * <code>.com.bht.pim.proto.employees.EmployeeInfo leader = 2;</code>
         */
        public Builder setLeader(EmployeeInfo value) {
            if (leaderBuilder_ == null) {
                if (value == null) {
                    throw new NullPointerException();
                }
         ...
         * <code>.com.bht.pim.proto.employees.EmployeeInfo leader = 2;</code>
         */
        public Builder mergeLeader(EmployeeInfo value) {
            if (leaderBuilder_ == null) {
                if (leader_ != null) {
                    leader_ =
                            EmployeeInfo.newBuilder(leader_).mergeFrom(value).buildPartial();
                } else {
                    leader_ = value;
                }
                onChanged();
         ...
         * <code>.com.bht.pim.proto.employees.EmployeeInfo leader = 2;</code>
         */
        public EmployeeInfo.Builder getLeaderBuilder() {
        ...
        public EmployeeInfoOrBuilder getLeaderOrBuilder() {
            if (leaderBuilder_ != null) {
                ...
                return leader_ == null ?
                        EmployeeInfo.getDefaultInstance() : leader_;
            }
        }
