...
/**
 * Protobuf type {@code com.bht.pim.proto.projects.ProjectId}
 */
public final class ProjectId extends
        com.google.protobuf.GeneratedMessageV3 implements
        // @@protoc_insertion_point(message_implements:com.bht.pim.proto.projects.ProjectId)
        ProjectIdOrBuilder {
    ...
    // @@protoc_insertion_point(class_scope:com.bht.pim.proto.projects.ProjectId)
    private static final ProjectId DEFAULT_INSTANCE;

    public static final com.google.protobuf.Descriptors.Descriptor
    getDescriptor() {
        return ProjectInfoOuterClass.internal_static_com_bht_pim_proto_projects_ProjectId_descriptor;
    }
    ...
    internalGetFieldAccessorTable() {
        return ProjectInfoOuterClass.internal_static_com_bht_pim_proto_projects_ProjectId_fieldAccessorTable
                .ensureFieldAccessorsInitialized(
                        ProjectId.class, ProjectId.Builder.class);
    }
    ...
    public static final class Builder extends
            ...
            // @@protoc_insertion_point(builder_implements:com.bht.pim.proto.projects.ProjectId)
            ProjectIdOrBuilder {
        // Construct using com.bht.pim.proto.projects.ProjectId.newBuilder()
        private Builder() {
        ...
        public Builder mergeFrom(ProjectId other) {
            if (other == ProjectId.getDefaultInstance()) {
                return this;
            }
            if (other.getId() != 0L) {
                setId(other.getId());
        ...
        // @@protoc_insertion_point(builder_scope:com.bht.pim.proto.projects.ProjectId)
    }
