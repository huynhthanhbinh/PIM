...
public abstract class GroupListService
        ...
        return new com.google.protobuf.BlockingService() {
            ...
            public final com.google.protobuf.Message callBlockingMethod(
                ...
                switch (method.getIndex()) {
                    case 0:
                        return impl.getGroupList(controller, (NoParam) request);
                    default:
    ...
    /**
     * <code>rpc getGroupList(.com.bht.pim.proto.groups.NoParam) returns (.com.bht.pim.proto.groups.GroupList);</code>
     */
    ...
    public final void callMethod(
        ...
        switch (method.getIndex()) {
            case 0:
                this.getGroupList(controller, (NoParam) request,
