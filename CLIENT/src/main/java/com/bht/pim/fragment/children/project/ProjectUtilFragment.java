...
public final class ProjectUtilFragment extends BaseFragment {
    ...
    private void initAllAttributes() {
        ImageView iReset = new ImageView(LoadingUtil.loadImage("reset"));
        ImageView iDelete = new ImageView(LoadingUtil.loadImage("delete"));
        ImageView iNew = new ImageView(LoadingUtil.loadImage("add"));
